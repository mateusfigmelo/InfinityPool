...
import {Quad, fromUint256, fromInt256, intoInt256, POSITIVE_ONE, POSITIVE_TWO, HALF} from "src/types/ABDKMathQuad/Quad.sol";
import {
    LOG1PPC,
    JUMPS,
    MIN_SPLITS,
...
function liquid(BoxcarTubFrame.Info storage self, int256 bin, int256 splits, Quad gamma, Quad deflator) view returns (Quad) {
    return fluidAt(self, bin, splits) - gamma * deflator;
}
